            ...
            if (zone) {
                ...
                if (water) {
                    ...
                    datasource.execute """  
                        ...
                        CREATE TABLE $sea_land_mask as select the_geom, id, type, ZINDEX from st_explode('(SELECT st_intersection(a.THE_GEOM, b.the_geom) as the_geom, a.id, a.type,a.ZINDEX 
