...
The user chooses the data set of his choice and ensures that the information present corresponds to the Geoclimate input model. 

![](./images/icons/arrow.png) [See more](./input_data/INPUT_DATA_MODEL.md)
