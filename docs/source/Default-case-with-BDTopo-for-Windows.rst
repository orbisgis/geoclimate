...
This tutorial presents how to create Local Climate Zones with BDTopo 2.2
or 3.0 version.
...
Get data from BD Topo on your computer
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Collect all your BDTopo data in one single folder (the folder can
contain many subfolders, the algorithm will find all needed data by
itself as long as you use the raw data supplied by the IGN). Currently,
the required files are the ones listed -
...
-  At RSU scale, we calculate the LCZ, the TEB inputs and the UTRF
   (“indicatorUse”: [“LCZ”, “TEB”, “URBAN_TYPOLOGY”]). We use the
   simplified method to calculate the sky view factor (“svfSimplified”:
   true).
