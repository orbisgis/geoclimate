...
1. building scale (see `building indicators output <Building-indicators.html>`_)
2. block of buildings (aggregation of buildings that are in contact – see `block indicators output <Block-indicators.html>`_)
3. chosen Reference Spatial Unit (RSU – see `RSU indicators output <RSU-indicators.html>`_)
...
1. Local Climate Zones (LCZ) classification, at the RSU scale (see `LCZ classification output <LCZ-classification.html>`_)
2. Urban Typology by Random Forest (UTRF) classification, computed at the building scale and aggregated at the RSU scale (see `UTRF classification output <UTRF-classification.html>`_)
...
- road-traffic indicators: more detail can be found at the page of the `road indicators output <Road-indicators.html>`_
- ground acoustic informations: more detail can be found at the page of the `ground acoustic output <Ground-acoustic.html>`_
