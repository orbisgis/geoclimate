...
CREATE TABLE veget_test (id int, the_geom geometry, height_class varchar, zindex int);
CREATE TABLE hydro_test (id int, the_geom geometry,zindex int);
CREATE TABLE rsu_test_all_indics_for_lcz(id_rsu int, sky_view_factor float, aspect_ratio float, BUILDING_FRACTION_LCZ float,
                                        ...
                                        AREA_FRACTION_HEAVY_INDUSTRY float, AREA_FRACTION_COMMERCIAL float,
                                        AREA_FRACTION_RESIDENTIAL float, AVG_NB_LEV_AREA_WEIGHTED float,
                                        GROUND_SKY_VIEW_FACTOR float, AREA_FRACTION_LIGHT_INDUSTRY float);
