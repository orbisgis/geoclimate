    ...
    id_zones.eachWithIndex { id_zone, index->
        ...
        if(prepareBDTopoData([datasource                 : h2gis_datasource,
            ...
            if(rsuIndicatorsToCompute){
                ...
                IProcess geoIndicators = Geoindicators.GeoIndicatorsChain.computeAllGeoIndicators()
            ...
            if(grid_indicators_params) {
                ...
                IProcess rasterizedIndicators =  Geoindicators.GeoIndicatorsChain.rasterizeIndicators()
