    ...
    return create {
        ...
        run { datasource, tableIrisName, tableBuildIndifName, tableBuildIndusName,
            ...
            if (!tablesExist.contains(tableRoadName)) {
                datasource.execute("DROP TABLE IF EXISTS $tableRoadName;  CREATE TABLE $tableRoadName (THE_GEOM geometry(linestring, $srid), ID varchar, LARGEUR DOUBLE, NATURE varchar, POS_SOL integer, FRANCHISST varchar);")
            }
