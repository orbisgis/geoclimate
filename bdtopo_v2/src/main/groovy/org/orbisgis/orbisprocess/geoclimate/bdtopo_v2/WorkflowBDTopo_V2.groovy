...
static def createOutputTables(def output_datasource, def outputTableNames, def srid){
    ...
    if (output_block_indicators && !output_datasource.hasTable(output_block_indicators)){
        output_datasource """
                CREATE TABLE $output_block_indicators (
                    ...
                    ID_RSU INTEGER, AREA DOUBLE,
                    FLOOR_AREA DOUBLE,VOLUME DOUBLE,
                    HOLE_AREA_DENSITY DOUBLE,
                    BUILDING_DIRECTION_EQUALITY DOUBLE,
                    BUILDING_DIRECTION_UNIQUENESS DOUBLE,
                    MAIN_BUILDING_DIRECTION VARCHAR,
                    CLOSINGNESS DOUBLE, NET_COMPACTNESS DOUBLE,
                    AVG_HEIGHT_ROOF_AREA_WEIGHTED DOUBLE,
                    STD_HEIGHT_ROOF_AREA_WEIGHTED DOUBLE,
                    ID_ZONE VARCHAR
                );
    ...
    if (output_building_indicators && !output_datasource.hasTable(output_building_indicators)){
        output_datasource """
                CREATE TABLE $output_building_indicators (
                        ...
                        VOLUME DOUBLE,
                        FLOOR_AREA DOUBLE,
                        TOTAL_FACADE_LENGTH DOUBLE,
                        CONTIGUITY DOUBLE,
                        COMMON_WALL_FRACTION DOUBLE,
                        NUMBER_BUILDING_NEIGHBOR BIGINT,
                        AREA_CONCAVITY DOUBLE,
                        FORM_FACTOR DOUBLE,
                        RAW_COMPACTNESS DOUBLE,
                        PERIMETER_CONVEXITY DOUBLE,
                        MINIMUM_BUILDING_SPACING DOUBLE,
                        ROAD_DISTANCE DOUBLE,
                        LIKELIHOOD_LARGE_BUILDING DOUBLE
                );
    ...
    ID_RSU INTEGER,
	THE_GEOM GEOMETRY(GEOMETRY,$srid),	
	HIGH_VEGETATION_FRACTION DOUBLE,
	HIGH_VEGETATION_WATER_FRACTION DOUBLE,
	HIGH_VEGETATION_BUILDING_FRACTION DOUBLE,
	HIGH_VEGETATION_LOW_VEGETATION_FRACTION DOUBLE,
	HIGH_VEGETATION_ROAD_FRACTION DOUBLE,
	HIGH_VEGETATION_IMPERVIOUS_FRACTION DOUBLE,
	WATER_FRACTION DOUBLE,
	BUILDING_FRACTION DOUBLE,
	LOW_VEGETATION_FRACTION DOUBLE,
	ROAD_FRACTION DOUBLE,
	IMPERVIOUS_FRACTION DOUBLE,
	VEGETATION_FRACTION_URB DOUBLE,
	LOW_VEGETATION_FRACTION_URB DOUBLE,
	HIGH_VEGETATION_IMPERVIOUS_FRACTION_URB DOUBLE,
	HIGH_VEGETATION_PERVIOUS_FRACTION_URB DOUBLE,
	ROAD_FRACTION_URB DOUBLE,
	IMPERVIOUS_FRACTION_URB DOUBLE,
	BUILDING_FRACTION_LCZ DOUBLE,
	PERVIOUS_FRACTION_LCZ DOUBLE,
	HIGH_VEGETATION_FRACTION_LCZ DOUBLE,
	LOW_VEGETATION_FRACTION_LCZ DOUBLE,
	IMPERVIOUS_FRACTION_LCZ DOUBLE,
	WATER_FRACTION_LCZ DOUBLE,
	AREA DOUBLE,
	AVG_HEIGHT_ROOF_AREA_WEIGHTED DOUBLE,
	STD_HEIGHT_ROOF_AREA_WEIGHTED DOUBLE,
	ROAD_DIRECTION_DISTRIBUTION_H0_D0_30 DOUBLE,
	...
	GROUND_LINEAR_ROAD_DENSITY DOUBLE,
	NON_VERT_ROOF_AREA_H0_10 DOUBLE,
	NON_VERT_ROOF_AREA_H10_20 DOUBLE,
	NON_VERT_ROOF_AREA_H20_30 DOUBLE,
	NON_VERT_ROOF_AREA_H30_40 DOUBLE,
	NON_VERT_ROOF_AREA_H40_50 DOUBLE,
	NON_VERT_ROOF_AREA_H50 DOUBLE,
	VERT_ROOF_AREA_H0_10 DOUBLE,
	VERT_ROOF_AREA_H10_20 DOUBLE,
	VERT_ROOF_AREA_H20_30 DOUBLE,
	VERT_ROOF_AREA_H30_40 DOUBLE,
	VERT_ROOF_AREA_H40_50 DOUBLE,
	VERT_ROOF_AREA_H50 DOUBLE,
	VERT_ROOF_DENSITY DOUBLE,
	NON_VERT_ROOF_DENSITY DOUBLE,
	FREE_EXTERNAL_FACADE_DENSITY DOUBLE,
	GEOM_AVG_HEIGHT_ROOF DOUBLE,
	BUILDING_VOLUME_DENSITY DOUBLE,
	AVG_VOLUME DOUBLE,
	AVG_NUMBER_BUILDING_NEIGHBOR DOUBLE,
	BUILDING_FLOOR_AREA_DENSITY DOUBLE,
	AVG_MINIMUM_BUILDING_SPACING DOUBLE,
	BUILDING_NUMBER_DENSITY DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H0_10_D0_30 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H10_20_D0_30 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H20_30_D0_30 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H30_40_D0_30 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H40_50_D0_30 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H50_D0_30 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H0_10_D30_60 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H10_20_D30_60 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H20_30_D30_60 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H30_40_D30_60 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H40_50_D30_60 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H50_D30_60 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H0_10_D60_90 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H10_20_D60_90 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H20_30_D60_90 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H30_40_D60_90 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H40_50_D60_90 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H50_D60_90 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H0_10_D90_120 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H10_20_D90_120 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H20_30_D90_120 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H30_40_D90_120 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H40_50_D90_120 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H50_D90_120 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H0_10_D120_150 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H10_20_D120_150 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H20_30_D120_150 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H30_40_D120_150 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H40_50_D120_150 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H50_D120_150 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H0_10_D150_180 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H10_20_D150_180 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H20_30_D150_180 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H30_40_D150_180 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H40_50_D150_180 DOUBLE,
	PROJECTED_FACADE_AREA_DISTRIBUTION_H50_D150_180 DOUBLE,
	BUILDING_TOTAL_FRACTION DOUBLE,
	ASPECT_RATIO DOUBLE,
	GROUND_SKY_VIEW_FACTOR DOUBLE,
	EFFECTIVE_TERRAIN_ROUGHNESS_LENGTH DOUBLE,
                        ...
                        if (diffCols) {
                            inputColumns.each { entry ->
                                if (diffCols.contains(entry.key)) {
                                    alterTable += "ALTER TABLE $output_table ADD COLUMN $entry.key ${entry.value.equalsIgnoreCase("double") ? "DOUBLE" : entry.value};"
