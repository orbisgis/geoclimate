...
class WorkflowBDTopoV2_2_Test extends WorkflowAbstractTest {
    ...
    void loadAndFormatData() {
        ...
        def process = BDTopo.WorkflowBDTopo_V2.loadAndFormatData()
    ...
    void runBDTopoWorkflowWithSRID() {
        ...
        def defaultParameters = BDTopo.WorkflowBDTopo_V2.extractProcessingParameters()
        ...
        def tablesToSave = [
                "rsu_lcz",]
        def process = BDTopo.WorkflowBDTopo_V2.bdtopo_processing(inseeCode, h2GISDatabase, defaultParameters, folder.absolutePath, tablesToSave, null, null, 4326, 2154);
