...
UPDATE $BUILDING_BD_TOPO_USE_TYPE SET ID_TYPE=(SELECT b.ID_TYPE FROM $BUILDING_ABSTRACT_USE_TYPE b WHERE b.TERM='industrial') WHERE NATURE ='Bâtiment industriel';
...
-- Initialize the table with all available CROSSING (FRANCHISSMT in the BD Topo v2.0)
DROP TABLE IF EXISTS $ROAD_BD_TOPO_CROSSING;
CREATE TABLE $ROAD_BD_TOPO_CROSSING (ID_FRANCHISSMT serial, FRANCHISSMT varchar, TABLE_NAME varchar, ID_CROSSING integer);
...
UPDATE $ROAD_BD_TOPO_CROSSING SET ID_CROSSING=(SELECT b.ID_CROSSING FROM $ROAD_ABSTRACT_CROSSING b WHERE b.TERM='null') WHERE FRANCHISSMT ='Gué ou radier';
UPDATE $ROAD_BD_TOPO_CROSSING SET ID_CROSSING=(SELECT b.ID_CROSSING FROM $ROAD_ABSTRACT_CROSSING b WHERE b.TERM='bridge') WHERE FRANCHISSMT ='Pont';
UPDATE $ROAD_BD_TOPO_CROSSING SET ID_CROSSING=(SELECT b.ID_CROSSING FROM $ROAD_ABSTRACT_CROSSING b WHERE b.TERM='tunnel') WHERE FRANCHISSMT ='Tunnel';
UPDATE $ROAD_BD_TOPO_CROSSING SET ID_CROSSING=(SELECT b.ID_CROSSING FROM $ROAD_ABSTRACT_CROSSING b WHERE b.TERM='null') WHERE FRANCHISSMT ='NC';
...
INSERT INTO $RAIL_BD_TOPO_CROSSING VALUES(null, 'Pont', 'ROUTE', null);
INSERT INTO $RAIL_BD_TOPO_CROSSING VALUES(null, 'Tunnel', 'ROUTE', null);
INSERT INTO $RAIL_BD_TOPO_CROSSING VALUES(null, 'NC', 'ROUTE', null);
